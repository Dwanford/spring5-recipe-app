package com.dwanford.spring5recipeapp.bootstrap;

import com.dwanford.spring5recipeapp.domain.*;
import com.dwanford.spring5recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipe() {
        ...
        guacRecipe.setSource("huh?");
        guacRecipe.setUrl("wwww.guacamole.com");
